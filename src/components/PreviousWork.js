    ...
    <Div className='previousWorkContainer'>
      ...
      <Row d='flex' flexDir={{ xs: 'column', sm: 'column', md: 'column', lg: 'row' }} justify={{ xs: 'center', sm: 'space-around' }} align='center'>
        ...
        <Col size={{ xs: '12', sm: '7', md: '5' }} d='flex' flexDir='column' justify='center' p={{ t: '2rem' }} >
          <Text textAlign={{ xs: 'center', md: 'left' }} textSize="subheader" >Heroic Challenges</Text>
          <Text textAlign={{ xs: 'center', md: 'left' }} textSize="paragraph"><em>Created in collaboration with <Anchor href='https://loresmyth.com/' target="_blank">LoreSmyth</Anchor></em></Text>
          <Text textAlign={{ xs: 'center', md: 'left' }} textSize="paragraph">Roleplaying Cards for Players and GMs - Discover hundreds of prompts that encourage creative play, deepen character choices and give rewards that go beyond gold and XP.</Text>
        </Col>
      </Row>
      ...
      <Row d='flex' flexDir={{ xs: 'column', sm: 'column', md: 'column', lg: 'row' }} justify={{ xs: 'center', sm: 'space-evenly' }} align='center' m={{ y: '4rem' }}>
        <Col size={{ xs: '12', sm: '7', md: '5' }} d='flex' flexDir='column' justify='center' order={{ xs: '2', lg: '1' }} p={{ t: '2rem' }}>
          <Text textAlign={{ xs: 'center', md: 'right' }} textSize="subheader">Remarkable Inns & Their Drinks</Text>
          <Text textAlign={{ xs: 'center', md: 'right' }} textSize="paragraph"><em>Created in collaboration with <Anchor href='https://loresmyth.com/' target="_blank">LoreSmyth</Anchor></em></Text>
          <Text textAlign={{ xs: 'center', md: 'right' }} textSize="paragraph">Best-selling, definitive guide to roleplaying taverns and inns - This richly detailed 88-page tome offers a wealth of new gameplay options, d&d inn maps, 8 ready-made taverns, NPC’s, rumors, secrets and over 1.000 random list options.</Text>
        </Col>
      ...
      <Row d='flex' flexDir={{ xs: 'column', sm: 'column', md: 'column', lg: 'row' }} justify={{ xs: 'center', sm: 'space-around' }} align='center'>
        ...
        <Col size={{ xs: '12', sm: '7', md: '5' }} d='flex' flexDir='column' justify='center' p={{ t: '2rem' }} >
          <Text textAlign={{ xs: 'center', md: 'left' }} textSize="subheader" >Remarkable Shops & Their Wares</Text>
          <Text textAlign={{ xs: 'center', md: 'left' }} textSize="paragraph"><em>Created in collaboration with <Anchor href='https://loresmyth.com/' target="_blank">LoreSmyth</Anchor></em></Text>
