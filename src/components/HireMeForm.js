...
import { Div, Input, Button, Text, Icon, Anchor } from 'atomize'
        ...
        <form onSubmit={handleSubmit(onSubmit)} w='100%'>
          ...
          <Div d='flex' >
            <Button
              ...
              m={{ r: "1rem" }}
            >Contact Us</Button>
            {error && <Text tag='p' textSize='body' textColor='danger800' p={{ t: '10px' }}>Sorry, an error occurred. Please contact me directly on <Anchor textColor='danger800' hoverTextColor='danger900' textWeight='600' href="mailto:jvcparry@hotmail.com">jvcparry@hotmail.com</Anchor></Text>}
