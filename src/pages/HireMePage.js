    ...
    <Container className='hireMeContainer'>
      <Row p={{ t: { xs: '2rem', sm: '4rem' }, x: { xs: '2rem', sm: '0' } }} d='flex' flexDir={{ xs: 'column', sm: 'row' }}>
        <Col size={{ xs: '12', sm: '8' }}>
          ...
          <Text tag="p" textSize={{ xs: 'paragraph', sm: 'subheader' }} p={{ y: '0.5rem' }}>If you'd like to discuss a project, <Anchor d="inline-block" href="#hire-form">get in touch</Anchor>!</Text>
        </Col>
